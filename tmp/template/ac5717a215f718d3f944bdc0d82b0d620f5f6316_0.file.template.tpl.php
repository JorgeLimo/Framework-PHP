...
productos">Mostrar</a>
            <a class="collapse-item" href="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
productos/agregar">Agregar</a>
            <a class="collapse-item" href="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
productos/categorias">Categorias</a>
            <a class="collapse-item" href="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
productos/proveedores">Proveedores</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo Session::get("nombres");?>
 <?php echo Session::get("apellidos");?>
</span>
                <img class="img-profile rounded-circle" src="<?php echo Session::get("foto");?>
">
              </a>
...
>
  ...
  <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['ruta_vendor'];?>
jquery-easing/jquery.easing.min.js"><?php echo '</script'; ?>
>

  <!-- Custom scripts for all pages-->
  <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['ruta_js'];?>
sb-admin-2.min.js"><?php echo '</script'; ?>
>
